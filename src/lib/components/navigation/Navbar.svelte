...
<nav
	class="md:h-navbar fixed top-0 inset-x-0 z-50 p-6 md:p-4 max-w-6xl md:mx-auto flex items-start md:items-center max-md:justify-end md:bg-gray-950 md:bg-opacity-50 md:backdrop-blur-md md:rounded-b-md"
>
	<ul
