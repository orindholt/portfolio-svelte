...
<nav
	class="h-navbar sticky md:fixed top-0 inset-x-0 z-50 px-6 md:px-4 max-w-6xl md:mx-auto flex items-center max-md:justify-end md:bg-gray-950/75 md:border max-lg:!border-x-0 border-t-0 border-gray-800 md:backdrop-blur-lg lg:rounded-b-md"
>
	<ul
	...
	<button
		...
		on:click={toggleMenu}
	>
		<!-- TODO: Add icon from previous portfolio -->
		{#if !isOpen}
			<svg
				fill="none"
				height="32"
